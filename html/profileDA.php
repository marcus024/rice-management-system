  ...
  function validateForm() {
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Profile /</span> DA Personnel's Profile</h4>
            <div class="row">
                <!-- Basic -->
                <div class="col-md-12">
                    <div class="card mb-4">
                        <h5 class="card-header">DA Personnel's Details</h5>
                            ...
                            <div class="row mb-3"></div>
                                ...
                                <div class="col- mb-4 text-center">
                                    <div class="rounded-circle overflow-hidden mx-auto d-block" style="width: 300px; height: 300px; border: 5px solid bluegrey;">
                                        <img
                                            src="data:image/jpg;base64,<?= base64_encode($_SESSION['daPic']); ?>"
                                            alt="View Badge User"
                    ...
                    <div class="input-group">
                        ...
                        type="textarea"
                        class="form-control"
                        placeholder="<?php echo  $_SESSION['nameP'] ?>"
                        aria-label="Username"
                    ...
                    <div></div>
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon11">Position</span>
                        <input
                        type="textarea"
                        class="form-control"
                        placeholder="<?php echo  $_SESSION['position'] ?>"
                        aria-label="Username"
                        aria-describedby="basic-addon11"
                        id = "name"
                        />
                    ...
                    <div class="input-group">
                        ...
                        type="textarea"
                        class="form-control"
                        placeholder="<?php echo  $_SESSION['emailP'] ?>"
                        aria-label="Username"
                        aria-describedby="basic-addon11"
                        />
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        type="textarea"
                        class="form-control"
                        placeholder="<?php echo  $_SESSION['passwordP'] ?>"
                        aria-label="Username"
                        aria-describedby="basic-addon11"
                        />
                    </div>
                    <div class="input-group">
                        ...
                        type="textarea"
                        class="form-control"
                        placeholder="<?php echo  $_SESSION['addressP'] ?>"
                        aria-label="Username"
                        aria-describedby="basic-addon11"
                        />
                    </div>
                    <div class="input-group">
                        ...
                        type="textarea"
                        class="form-control"
                        placeholder="<?php echo  $_SESSION['contactP'] ?>"
                        aria-label="Username"
                        aria-describedby="basic-addon11"
                        />
                    </div>
                    <div class="demo-inline-spacing">
                    <a href="daout.php" class="btn btn-danger">Logout</a>
                    </div>
                    <div></div>
                </div>
            </div>
